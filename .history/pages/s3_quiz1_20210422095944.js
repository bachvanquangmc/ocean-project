...
export default function S3page({
    ...
    return<S3Wraper>
                <HiddenMenu />
            <S3Content>
                <S3text titleColor='yellow' textTitle='Quiz One: What can I do to help prevent climate change?' textBody='What can I do to help prevent climate change?'></S3text>
            </S3Content>
            <S3Content>
                <QizUI qizIndex='1' qizTitle='Right' qizTitle='' qizText='Test Right' callBack={process}/>
