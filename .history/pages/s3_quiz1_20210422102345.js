...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                <QizUI qizIndex='1' qizTitle='Right' qizTitle='Conserve Water' qizText='Watch your water usage by turning off faucets when not in use, taking shorter showers, and avoiding unnecessary water consumption.' callBack={process}/>
                ...
                <QizUIr qizIndex='1' qizTitle='Walk and Travel Green' qizText='Walking or biking to the local stores or taking publick transport could reduce you carbon footprint. Getting an electric car and reduce emissions' callBack={process}/>
