...
export default function HomeBody() {
  return<Home>
            ...
            <NewCategory CatName="Importance" text="Ocean is so important to us" direction="right"/>
            <NewCategory CatName="Threats" text="To the ocean" direction="left"/>
            <NewCategory CatName="Protection" text="Things we can do to save the ocean" direction="right" />
