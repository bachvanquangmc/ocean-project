...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                ...
                <QizUI qizIndex='1' qizTitle='Save Energy' qizText='Use less energy by turning off appliances when not in use, switching to energy saving bulb' callBack={process}/>
