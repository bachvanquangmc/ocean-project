...
export default function S3page() {
  return<S3Wraper>
            ...
            <QizUI qizTitle='Reduce Your Waste' qizText='Reducing the amount fo energy used in the pumping of water reduces our carbon emissions'/>
            <QizUI qizTitle='Conserve Water' qizText='Reducing the amount fo energy used in the pumping of water reduces our carbon emissions' />
