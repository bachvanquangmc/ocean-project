...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                ...
                <QizUIr qizIndex='1' qizTitle='Walk and Travel Green' qizText='Walking orto the local stores or taking publick transport could reduce you carbon footprint. Getting an electric car and reduce emissions' callBack={process}/>
