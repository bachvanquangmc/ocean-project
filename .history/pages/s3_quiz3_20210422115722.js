...
export default function S3page({
    ...
    return<S3Wraper>
                <HiddenMenu />
            <S3Content>
                <S3text titleColor='yellow' textTitle='Quiz Three: What are Canadian sustainable seafoord' textBody='Please click on the ways you think it will work'></S3text>
            </S3Content>
            <S3Content>
                <QizUI qizIndex='-1' qizTitle='Wrong' callBack={process}/>
