...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                ...
                <QizUI qizIndex='1' qizTitle='Generate Clean Green Energy' qizText='Recycling eliminates the need for new raw materials to make new products.' callBack={process}/>
