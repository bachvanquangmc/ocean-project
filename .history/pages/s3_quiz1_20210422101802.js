...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                ...
                <QizUI qizIndex='1' qizTitle='Stand Up and Get Involved' qizText='Speaking up is one of the most powerful things you can do especially if it'' callBack={process}/>
