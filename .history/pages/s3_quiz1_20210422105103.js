...
export default function S3page({
    ...
    return<S3Wraper>
                <HiddenMenu />
            <S3Content>
                <S3text titleColor={Quiz1Score}. textTitle='Quiz One: What can I do to help prevent climate change?' textBody='Please click on the ways you think it will work'></S3text>
            </S3Content>
            <S3Content>
                <QizUI qizIndex='1'  qizTitle='Conserve Water' qizText='Watch your water usage by turning off faucets when not in use, taking shorter showers, and avoiding unnecessary water consumption.' callBack={process}/>
