...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                <QizUI qizIndex='1' qizTitle='Right' qizTitle='Conserve Water' qizText='Reducing the amount of energy used in the pumping of water reduce our  emissions' callBack={process}/>
