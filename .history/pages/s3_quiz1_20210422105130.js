...
export default function S3page({
    ...
    return<S3Wraper>
            ...
            <S3Content>
                <QizUI qizIndex={quiz1.Q1.}  qizTitle='Conserve Water' qizText='Watch your water usage by turning off faucets when not in use, taking shorter showers, and avoiding unnecessary water consumption.' callBack={process}/>
